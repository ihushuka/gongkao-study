...
type Tab = "home" | "daily" | "sleep" | "plan" | "study" | "practice" | "idiom" | "mistakes" | "review" | "reports" | "settings";
...
type Task = { id: number; title: string; subject: string; minutes: number; done: boolean; date?: string; plannedStart?: string; plannedEnd?: string; plannedSlots?: TimeSlot[]; supervision?: SupervisionState };
...
export default function App() {
  ...
  else if (tab === "plan") page = <Plan tasks={tasks} setTasks={setTasks} routines={routines} setRoutines={setRoutines} flash={flash} moduleOptions={moduleOptions} />;
  ...
  else if (tab === "practice") page = <PracticeView practices={practices} setPractices={setPractices} flash={flash} moduleOptions={moduleOptions} setModuleOptions={setModuleOptions} timer={sharedTimer} />;
...
function Plan({ tasks, setTasks, routines, setRoutines, flash, moduleOptions }: { tasks: Task[]; setTasks: Dispatch<SetStateAction<Task[]>>; routines: DailyRoutine[]; setRoutines: Dispatch<SetStateAction<DailyRoutine[]>>; flash: (x: string) => void; moduleOptions: string[] }) {
...
function PracticeView({ practices, setPractices, flash, moduleOptions, setModuleOptions, timer }: { practices: Practice[]; setPractices: Dispatch<SetStateAction<Practice[]>>; flash: (x: string) => void; moduleOptions: string[]; setModuleOptions: Dispatch<SetStateAction<string[]>>; timer: TimerShared }) {

...
type LifeEventCategory = "吃饭" | "睡觉" | "健身" | "通勤" | "洗漱" | "家务" | "休息" | "其他";
...
const lifeEventIcon = (category: LifeEventCategory) => ({ "吃饭": "餐", "睡觉": "眠", "健身": "练", "通勤": "行", "洗漱": "洗", "家务": "家", "休息": "休", "其他": "记" }[category]);
...
function DailyPlan({ tasks, setTasks, routines, setRoutines, sessions, timer }: { tasks: Task[]; setTasks: Dispatch<SetStateAction<Task[]>>; routines: DailyRoutine[]; setRoutines: Dispatch<SetStateAction<DailyRoutine[]>>; sessions: StudySession[]; timer: TimerShared }) {
  ...
  const saveLifeEvent = (event: FormEvent) => {
    ...
    const next: LifeEvent = { id: lifeEditingId || Date.now(), date: normalizedDate(lifeDate), category: lifeCategory, title: lifeTitle.trim() || lifeCategory, side: lifeSide, startTime: lifeStart, endTime: lifeEnd, note: lifeNote.trim() || undefined };

...
function DailyBriefing() {
  ...
  const [source, setSource] = useState<SourceKey>("people"), [allNews, setAllNews] = useState<Record<SourceKey, NewsItem[]>>({ xuexi: [], people: [], gov: [] }), [updatedAt, setUpdatedAt] = useState(""), [feedDate, setFeedDate] = useState(""), [loading, setLoading] = useState(true), [showAnswer, setShowAnswer] = useState(false), [showAnswer2, setShowAnswer2] = useState(false), [refreshKey, setRefreshKey] = useState(0);
